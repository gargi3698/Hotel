...
(2, 'Superior Room', 'Single', 'Free', NULL),
(3, 'Deluxe Room', 'Single', 'Free', NULL),
(4, 'Deluxe Room', 'Single', 'Free', NULL),
(5, 'Guest House', 'Single', 'Free', NULL),
(6, 'Guest House', 'Single', 'Free', NULL),
(7, 'Single Room', 'Single', 'Free', NULL),
(8, 'Single Room', 'Single', 'Free', NULL);
...
`id` int(10) unsigned NOT NULL,
  ...
  `tofair` varchar(20) DEFAULT NULL,
  `cin` date DEFAULT NULL,
  `cout` date DEFAULT NULL,
