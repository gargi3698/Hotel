...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>ATHITI HOTEL,</p>
				<p>New Kalmunani Road,<br>Jaipur,<br>India.</p>
				<p>+91 9898562134</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span ><?php echo $tofair; ?>  </span></td>
						<td><span ><?php echo $days; ?></span></td>
						<td><span data-prefix>₹</span><span ><?php  echo $type_of_visit?></span></td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix>₹</span><span><?php echo $fair_price; ?></span></td>
					</tr>
				</tbody>
			</table>
