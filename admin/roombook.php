        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i> Feedback</a>
                    </li>
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Room Booking</a>
                    </li>
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> Bill</a>
                    </li>
					<!-- <li>
                        <a  href="profit.php"><i class="fa fa-qrcode"></i> Profit</a>
                    </li> -->
                     <li>
                        <a  href="treserv.php"><i class="fa fa-file-text-o"></i> Total Reservation</a>
                    </li> 
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														else if($tofair=="Visit Temple")
														{
															$type_of_visit=500;
														}else if($tofair=="Visit Park")
														{
															$type_of_visit=600;
														
														}else if($tofair=="Visit Museum & Zoo")
														{
															$type_of_visit=800;
														}else if($tofair=="Visit Palace")
														{
															$type_of_visit=2000;
														}else if($tofair=="All Palces")
														{
															$type_of_visit=3500;
														}
														...
														$fprice = $type_of_visit; 
														$fintot = $ttot + $mepr + $btot +$fprice;
															
															//echo "<script type='text/javascript'> alert('$count_date')</script>";
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`,`tfair`, `mepr`, `btot`,`fintot`,`fprice`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$tofair','$mepr','$btot','$fintot','$fprice','$days')";
														$psql2 = "INSERT INTO `treservation`(`id`,`title`, `fname`, `lname`, `troom`, `nroom`, `cin`, `cout`,`meal`,`tfair`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$nroom','$cin','$cout','$meal','$tofair','$days')";
